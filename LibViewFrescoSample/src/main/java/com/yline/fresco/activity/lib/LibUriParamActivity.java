...
public class LibUriParamActivity extends BaseAppCompatActivity {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            FrescoManager.setImageUri(frescoView, uriStr, 640, 960);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lib_uri_param);

        frescoView = (FrescoView) findViewById(R.id.lib_uri_param_fresco_view);
        tvHint = (TextView) findViewById(R.id.lib_uri_param_tv_hint);
    ...
    public static void launcher(Context context) {
        if (null != context) {
            Intent intent = new Intent(context, LibUriParamActivity.class);
