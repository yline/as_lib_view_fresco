...
public class LibControllerDynamicActivity extends BaseAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lib_controller_dynamic);

        frescoView = (FrescoView) findViewById(R.id.lib_controller_dynamic_fresco_view);
        tvHint = (TextView) findViewById(R.id.lib_controller_dynamic_tv_hint);
    ...
    public static void launcher(Context context)
    {
    	if (null != context)
    	{
    		Intent intent = new Intent(context, LibControllerDynamicActivity.class);
